...
function Footer() {
    return (
        <footer className="bg-white rounded-md shadow m-4 mt-0 dark:bg-slate-800">
            ...
            <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
                ...
                <li>
                    <a href="https://github.com/rajputshashank003/Elasticity_gsap" className="hover:underline me-4 md:me-6">Project Repository</a>
                </li>
                <li>
