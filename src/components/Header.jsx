...
const Header = () => {
    ...
    useGSAP(() => {
        gsap.to(".header",{
            y : !scrollDirection ? 0 : -100,
            duration : 0.5,
            ease : "power4.inOut" ,
        });
        gsap.to(".header_options, .header_text", {
