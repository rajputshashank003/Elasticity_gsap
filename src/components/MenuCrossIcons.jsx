...
const MenuCrossIcons = () => {
    ...
    return (
        <div onClick={handleClick} className='relative cursor-pointer mt-6 h-[1.5rem] w-[2rem]'>
            <div className='absolute l1 top-[-0.25rem] h-[0.2rem] rounded-xl w-[1.9rem] bg-[#E7CFB1]'/>
            <div className='absolute l2 top-[0.25rem]  h-[0.2rem] rounded-xl w-[1.9rem] bg-[#E7CFB1]'/>
        </div>
    )
}
